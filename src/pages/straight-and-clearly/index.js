  ...
  return (
    <div className="max-w-[1440px] mx-auto px-[150px]">
      ...
      <div className="w-full  mt-4 ">
        ...
        <h2 className="font-normal text-[48px] leading-[48px] text-gray-800 mb-6">
          Find art just for you
        </h2>

        <p className="font-normal text-xs leading-[20px] text-gray-700 mb-10">
          This questionnaire will help us to determine art pieces most suitable for you
        </p>
      </div>
      {/* progress bar*/}
      <div className="w-fit flex  flex-col gap-[5px] justify-center ">
        <div className="flex items-center gap-4">
          ...
          <div className="">
            <p className="font-normal text-sm text-gray-800 mb-1">We start with</p>
            <p className="font-semibold text-lg border-green-600 m-0">Preference Questionary</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="">
            <p className="font-semibold text-lg border-green-600 m-0">Negative Filter</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="">
            <p className="font-semibold text-lg border-green-600 m-0">Art Swiper</p>
          </div>
        </div>
        <div className="w-[1px] h-[42px] bg-gray-800  ml-5" />
      ...
      <button className="w-[365px] h-auto mt-10 mb-[76px] px-[18px] py-[11px] flex items-center justify-center font-semibold text-base text-white bg-green-600 ">
        Start Questionnaire
      </button>
    </div>
  );
