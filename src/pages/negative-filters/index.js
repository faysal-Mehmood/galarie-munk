    ...
    <div className="max-w-[1440px] mx-auto ">
      ...
      <div className="px-[20px] md:px-[clamp(10px,11vw,150px)] text-center">
        <h2 className="font-normal text-[30px] leading-[36px] md:text-[48px] md:leading-[48px] text-gray-800 mb-1 md:mb-2">
          Click on the pictures that don’t match your taste
        </h2>
        <p className="font-normal text-sm text-gray-800 mb-10">
          We’ll use them to suggest items chosen for you
        </p>
        {/* pictures cards */}
        <div className="flex items-center gap-x-3 md:gap-x-5 gap-y-4 flex-wrap">
          {/* cards */}
          <div className="w-[212px] h-[173px] relative overflow-hidden border-[1px] border-solid border-red-500">
            <img
              src={CardImg}
              alt="card img"
              className="w-[212px] h-[173px] object-contain"
            />
            <div className="w-full h-full bg-blackRGB absolute top-0 left-0 z-[1]">
